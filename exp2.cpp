/*Experiment no 2: Like Uber, CNG owners want to develop a software which can communicate with customer and driver.
 A customer needs to say his/her destination and nearer CNG driver will get message from the Uber company with name
  and mobile number of the customer. The driver can make a direct call and if the customer confirms the ride
  then driver will come to spot and carry the passenger. As a student of CSE, write OOP code for the project.
...
{
    Customer customer("Rafi",1,2345,"Sylhet",23,91);
    Driver driver1("Nowshin",2,72567,"Comilla",21,93);
    Driver driver2("Akram",3,8652,"Chittagong",22,91);
    driver1.driverfile();
