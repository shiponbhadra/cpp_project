/*Experiment no 3: CSE department wants to manage a Fast-food shop in its premise. Every student can make pre-order
of his/her breakfast before 10 PM of the previous day. A sales person can manage the data and sells the preordered
item to the students. If a student pre-ordered before but not take his/her breakfast and the sales person can inform
it to the department. If he will not be illegible to pre-order the breakfast another time. As a student of CSE,
...
int main()
{
    ...
    {
        new Student("Rodrita","28-9-1997",department,"1001"),
        new Student("Avro","1-5-1998",department,"1002"),
        new Student("Oniket","7-11-1995",department,"1003"),
        new Student("Smrity","12-09-1997",department,"1004")
    };

    Sellsman sells_person("Abdul","13-03-1985",1);
    ...
    {
        new Faculty("Chairmain","Kamal Chowdhury",department,login_data[0]),
        new Faculty("Lecturer","Arman",department,login_data[1])
    };
    for(int i=0;i<3;i++)
